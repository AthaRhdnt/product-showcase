    ...
    <x-slot name="data_control">
        <div
            ...
            <a href="{{ route('admin.categories.create') }}">
                <x-button class="bg-indigo-600 hover:bg-indigo-700">+ Add Category</x-button>
            </a>
        </div>
    </x-slot>
    ...
    <div class="mt-6 px-4 overflow-x-auto">
        <table
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="2" class="p-4 text-center text-gray-500 dark:text-gray-400">No categories found.
                        </td>
                    </tr>
                @endforelse
            </tbody>
